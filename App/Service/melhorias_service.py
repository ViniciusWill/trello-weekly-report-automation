...
def formatar_planilha_melhorias(writer, df_final, nome_planilha, titulo_planilha, cor):
    """Aplica o layout de LISTA PLANA (Melhorias) com totalizadores."""
    print(f"Formatando planilha MELHORIAS: {nome_planilha}...")
    ...
    # - Tabela Principal 
    worksheet.merge_range('A1:D1', titulo_planilha, formato_titulo)
    worksheet.write('A2', 'Descrição', formato_cabecalho); worksheet.write('B2', 'Membro', formato_cabecalho)
    worksheet.write('C2', 'Total HR', formato_cabecalho); worksheet.write('D2', 'Total - Tempo em Desenvolvimento', formato_cabecalho)
